...
"""
print('Loading data......')
sub_train_images, sub_train_labels, sub_test_images, sub_test_labels = init_subset('8145') # input your ASUID last 4 digits here to generate the subset samples of MNIST for training and testing
...
plt.plot(np.array(train_acc_list), np.array(epoch_list))
...
plt.plot(train_loss_list, epoch_list)
...
plt.plot(test_acc_list, epoch_list)
...
plt.plot(test_loss_list, epoch_list)
